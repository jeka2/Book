...
ActiveRecord::Schema.define(version: 20190125230056) do
  ...
  create_table "rating_counters", force: :cascade do |t|
    t.integer "user_id"
    t.integer "book_id"
    t.integer "rating"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_rating_counters_on_book_id"
    t.index ["user_id"], name: "index_rating_counters_on_user_id"
  end
